...
function App() {
  ...
  const [analysisTeams, setAnalysisTeams] = useState({ team1: '', team2: '' });

  const handleViewAnalysis = (team1, team2) => {
    setAnalysisTeams({ team1: team1 || '', team2: team2 || '' });
      ...
      <div className="app-content">
        ...
        <div className="tabs-container">
          ...
          <div className="tab-content">
            {activeTab === 'events' && (
              <ErrorBoundary>
                <EventsList onViewAnalysis={handleViewAnalysis} />
              </ErrorBoundary>
            )}
            {activeTab === 'predictions' && (
              <ErrorBoundary>
                <PredictionDashboard initialTeam1={analysisTeams.team1} initialTeam2={analysisTeams.team2} />
              </ErrorBoundary>
            )}
            {activeTab === 'betting' && (
              <ErrorBoundary>
