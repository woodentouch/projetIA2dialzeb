...
import { IconCalendar, IconClock, IconFlame, IconTrendingUp, IconChartBar, IconTrophy } from '@tabler/icons-react';
...
export default function EventsList({ onViewAnalysis }) {
              ...
              >
                ...
                <Stack spacing="md">
                  ...
                  <button 
                    ...
                    onClick={() => onViewAnalysis?.(event?.team1, event?.team2)}
                  >
